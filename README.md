...
The legacy site supplied Bruce Saxton's biography, the firm's founding year, client scope, portrait, and displayed contact details. Its email link incorrectly targeted a placeholder; this site uses the displayed `[contact removed]` address. Do not introduce unverified coach credentials, client names, or testimonials.
